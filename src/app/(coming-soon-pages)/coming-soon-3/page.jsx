...
import comingSoonImg from '@/assets/images/soon/img-soon-2.jpg';
import PageMetaData from '@/components/PageMetaData';
const ComingSoon3 = () => {
  return <>
      <PageMetaData title='Coming Soon' />
      <section className="relative flex items-center bg-[url(../images/small/small-3.jpg)] bg-cover bg-right-bottom bg-no-repeat p-4 md:p-6 lg:h-screen">
            ...
            <div className="grid items-center lg:grid-cols-2">
              <div className="relative order-2 p-8 text-white lg:order-1">
                <Link to="/" className="mb-10 flex items-center">
                  <img height={64} width={64} src={logo} alt="logo" className="h-16" />
                </Link>
                ...
                <div className="mt-10">
                  ...
                  <div className="rounded-md bg-white/20 backdrop-blur-2xl">
                    <form className="mt-7 flex w-full items-center justify-between">
                      ...
                      <button className="me-2 rounded-md border-0 bg-white/10 px-6 py-2 text-sm font-semibold text-white backdrop-blur-2xl transition-all duration-500 hover:bg-black/40 hover:text-black">
              ...
              <div className="order-1 h-full w-full p-8 lg:order-2">
                <img src={comingSoonImg} alt="coming-soon" className="h-full w-full rounded-lg" />
              </div>
            </div>
          </div>
        </div>
